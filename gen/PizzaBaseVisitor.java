...
/**
 * This class provides an empty implementation of {@link PizzaVisitor},
 ...
 */
public class PizzaBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements PizzaVisitor<T> {
	/**
	 * {@inheritDoc}
	 *
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitLisaPitsa(@NotNull PizzaParser.LisaPitsaContext ctx) { return visitChildren(ctx); }
}